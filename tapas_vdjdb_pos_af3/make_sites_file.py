...
def find_cif(base_dir, pdb_id, model_number):
    ...
    candidates = [
        ...
        os.path.join(sample_dir, f"v0_model.cif"),          # fallback fixed name
        os.path.join(sample_dir, "model.cif"),
    ]
    # Fallback: any *.cif in the sample directory
    ...
    if glob_hits:
        return glob_hits[0]   # first match
...
def main():
    ...
    parser.add_argument('--base_dir',      required=True,
                        help='Root directory of AF3 structure predictions (e.g. af3_structpred)')
