...
def main(model_folder, output_folder): 
    ...
    pdb_ids = [x.split('/')[-1] for x in glob.glob('/vtmount/genesis/ha01994/af3_structpred/af3_immrep23/*')]
    ...
    for pdb_id in pdb_ids:
        ...
        for model_number in range(5):
            ...
            pdb_model = f'/vtmount/genesis/ha01994/af3_structpred/af3_immrep23/{pdb_id}/seed-1_sample-{model_number}/{pdb_id}_seed-1_sample-{model_number}_model.cif'
            summary_json = f'/vtmount/genesis/ha01994/af3_structpred/af3_immrep23/{pdb_id}/seed-1_sample-{model_number}/{pdb_id}_seed-1_sample-{model_number}_summary_confidences.json'
            all_data_json = f'/vtmount/genesis/ha01994/af3_structpred/af3_immrep23/{pdb_id}/seed-1_sample-{model_number}/{pdb_id}_seed-1_sample-{model_number}_confidences.json'
