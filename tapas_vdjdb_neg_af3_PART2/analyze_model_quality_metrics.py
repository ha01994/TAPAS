...
def main(model_folder, output_folder): 
    ...
    csv_path = f"{output_folder}/results_model_quality_metrics_part2.csv"
            
    pdb_ids = [x.split('/')[-1] for x in glob.glob('/mnt/storage/shared_folder/af_output/*')]
    ...
    for pdb_id in pdb_ids:
        ...
        for model_number in range(5):
            ...
            if f"{pdb_id}" == "v1953_rs_2_n0":
                continue
            if f"{pdb_id}" == "v1953_rs_3_n0":
                continue            

            pdb_model = f'/mnt/storage/shared_folder/af_output/{pdb_id}/seed-1_sample-{model_number}/{pdb_id}_seed-1_sample-{model_number}_model.cif'
            summary_json = f'/mnt/storage/shared_folder/af_output/{pdb_id}/seed-1_sample-{model_number}/{pdb_id}_seed-1_sample-{model_number}_summary_confidences.json'
            all_data_json = f'/mnt/storage/shared_folder/af_output/{pdb_id}/seed-1_sample-{model_number}/{pdb_id}_seed-1_sample-{model_number}_confidences.json'
