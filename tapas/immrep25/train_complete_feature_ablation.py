...
raw pair probabilities. The script reports peptide Macro-AUC and Macro-AUC@0.1.
"""
...
def main() -> None:
    ...
    for feature_set, model_predictions in predictions_by_feature.items():
        ...
        peptide_result = ensemble.per_peptide_auc(labels, raw, peptides)
        peptide_result.insert(0, "score_stage", "raw")
        ...
        summary_rows.append(
            {
                ...
                "raw_macro_auc": peptide_result["auc"].mean(),
                "raw_macro_auc_0.1": peptide_result["auc_0.1"].mean(),
            }
        )
