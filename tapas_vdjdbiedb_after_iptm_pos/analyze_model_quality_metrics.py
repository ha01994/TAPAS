...
def main(model_folder, output_folder): 
    ...
    ids_0 = [x.split('/')[-1] for x in glob.glob('/shared/ha01994/alphafast_vdjdb_iedb/vdjdb_iedb_alphafast_output/*')]
    ids_1 = []
    ids_2 = []
    pdb_ids = ids_0 + ids_1 + ids_2 
    ...
    for pdb_id in pdb_ids:
        ...
        for model_number in range(5):
            ...
            if pdb_id in ids_0: foldername = '0'                    
            if pdb_id in ids_1: foldername = '1'
            if pdb_id in ids_2: foldername = '2'
            
            pdb_model = f'/shared/ha01994/alphafast_vdjdb_iedb/vdjdb_iedb_alphafast_output/{pdb_id}/seed-1_sample-{model_number}/{pdb_id}_seed-1_sample-{model_number}_model.cif'            
            summary_json = f'/shared/ha01994/alphafast_vdjdb_iedb/vdjdb_iedb_alphafast_output/{pdb_id}/seed-1_sample-{model_number}/{pdb_id}_seed-1_sample-{model_number}_summary_confidences.json'            
            all_data_json = f'/shared/ha01994/alphafast_vdjdb_iedb/vdjdb_iedb_alphafast_output/{pdb_id}/seed-1_sample-{model_number}/{pdb_id}_seed-1_sample-{model_number}_confidences.json'
